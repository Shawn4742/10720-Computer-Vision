...
import LucasKanade_Robust as LKB
...
if data_name == 'car1':
    ...
    initial = np.array([700, 180, 775, 280])      
else:
...
# data = LKB.scale_brightness(data)
for i in range(numFrames-1):
    ...
    # run algorithm
    dx, dy = LKB.LucasKanade_M2(It, It1, rect)
    print("dx,dy ", (dx,dy))
    ...
    save_path = "../results/lk_robust_M2/%s/frame%06d.jpg" % (data_name, i+1)

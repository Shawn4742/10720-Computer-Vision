...
if __name__ == '__main__':
    ...
    # path_img = "../data/laundromat/sun_adoskwanicxyfwdg.jpg"
    ...
    # hist = visual_recog.get_feature_from_wordmap(wordmap, dict_size)
    # # hist = visual_recog.get_feature_from_wordmap_SPM(wordmap, 3, dict_size)
    # print(sum(hist))
    # print(len(hist))
